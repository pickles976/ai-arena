...
import { GameObjectManager, USER_CODE_MAX_SIZE } from '../globals.js';
import { ENERGY_SCALE } from '../config/gameConfig.js'
...
export const energyDiff = function (thisObject: GameObject, otherObject: GameObject) {
    return (
        (ENERGY_SCALE *
            ...
            thisObject.transform.velocity.subtract(otherObject.transform.velocity).magnitude ** 2) /
        2
    );
};
